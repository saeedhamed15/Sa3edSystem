...
${prefix}inv/لدعوة البوت الى سيرفرك https://discordapp.com/api/oauth2/authorize?client_id=576513698231877642&permissions=8&scope=bot
${prefix}support/سيرفر الدعم https://discord.gg/JenDxwt
${prefix}contact/ارسال اقتراح او لمراسلة صاحب البوت@The FourtHPyramid#4144 
**
  `
,`
...
client.on('message', message => {
    ...
    translate(finalToTrans, {to: language}).then(res => {
            message.channel.send({embed: {
                color: 3447003,
                author: {
                  name: 'Darke Community ©\'s translator',
